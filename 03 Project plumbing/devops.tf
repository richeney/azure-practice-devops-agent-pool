...
locals {
  ...
  agent_pool_configuration = var.azure_devops_self_hosted_agents ? "name: ${var.agent_pool_name}" : "vmImage: ubuntu-latest"
...
data "azuredevops_agent_pool" "terraform" {
  name = var.agent_pool_name
}

resource "azuredevops_agent_queue" "terraform" {
  project_id    = data.azuredevops_project.project.id
  agent_pool_id = data.azuredevops_agent_pool.terraform.id
}
